<template>
    <div>
      ...
      <all-bread><span>address</span></all-bread>
...
<div slot="btnGroup">
  <a class="btn btn--m" herf="javascript:;" @click="delAddress">确定</a>
  <a class="btn btn--m" herf="javascript:;" @click="isMdShow=false">取消</a>
</div>
