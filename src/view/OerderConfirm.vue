<template>
    <div>
        ...
        <all-bread><span>Order Confirm</span></all-bread>
      ...
      <div class="item-list-wrap confirm-item-list-wrap">
        <div class="cart-item order-item">
          ...
          <ul class="cart-item-list">
            <li v-for="(item,index) in cartList" v-show="item.checked=='1'" :key="index">
      ...
      init(){
        axios.get('/users/cartList').then((response)=>{
          ...
          if(res.status=='0'){
            ...
            this.priceTotal+=this.subTotal+this.shipping+this.tax-this.discount;
